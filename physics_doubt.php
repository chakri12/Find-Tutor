...
$sql='select * from subscription where physics=1 and id='.$_SESSION['id'].'';
$result=mysqli_query($link,$sql);
$rows=mysqli_num_rows($result);
if($rows==0)
{
    header("Location:subscription.php");
    echo "Please subscribe to post the question.";
}	
...
$query=mysqli_prepare($link,"insert into ques(stu_id,question,subject,issolved) values(?,?,'physics',0);");
  mysqli_stmt_bind_param($query,'is',$id,$question);
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
  <h2>Type here.</h2>
  <textarea name="question" rows="25" cols="100"><?php echo $question;?></textarea>
  <br><br>
