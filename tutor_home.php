...
<div style="padding-left:16px">
  <h2>Add Some content about the website in this homepage.</h2>
</div> -->
<div class="container">
       <div class="row ">
     <div class="table-responsive">
      ...
      <thead>
        ...
        <?php
        $query=mysqli_query($link,"select ques_id,question,subject from ques where issolved=0;");
          while($row = mysqli_fetch_row($query))
          {
          $ques_id=$row[0];
          $question=substr($row[1],0,15);
          $subject=$row[2];
          echo "<tr>";
          //$matchdata=json_encode($row);
          echo "<td><a href=sol.php?ques_id=".$ques_id.">". $ques_id . "</td>";
          echo "<td><a href=sol.php?ques_id=".$ques_id.">" . $question . "</td>";
          echo "<td>" . $subject . "</td>";
          echo "</tr>";
          }
