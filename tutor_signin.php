...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    else
    {
        ...
        if($stmt = mysqli_prepare($link, $sql))
        {
            ...
            {
                echo "UserName Sql statement not executed";
    ...
    {
       $phone_err = "Please enter a 10 digit number.";     
    }
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err) && empty($email_err) && empty($phone_err))
    {
        ...
        $sql = "INSERT INTO tutor (username, passwd,emailId,phone) VALUES ('$username','$password','$email','$phone')";    
...
<body>
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Already have an account? <a href="tutor_login.php">Login here</a>.</p>
        </form>
    </div>    
</body>
</html>