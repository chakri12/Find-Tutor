...
$sql='select * from subscription where maths=1 and id='.$_SESSION['id'].'';
...
$query=mysqli_prepare($link,"insert into ques(stu_id,question,subject,issolved) values(?,?,'maths',0);");
